const SearchedNewsCard = ({searchedarticle}) => {
    ...
    return (
      ...
      <div className="news-card">
        <div className="img">
          <img src={multimediaValue()} alt={searchedarticle.snippet} />
        </div>
